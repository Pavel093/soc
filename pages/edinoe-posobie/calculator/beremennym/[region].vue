    ...
    <article class="calculator-page">
      ...
      <section class="faq-section">
        ...
        <details class="faq-item">
          <summary>Что такое единое пособие для беременных?</summary>
          <p>Единое пособие для беременных — это мера государственной поддержки женщин, вставших на медицинский учет в ранние сроки беременности. Выплата назначается при условии, что среднедушевой доход семьи не превышает прожиточный минимум в регионе.</p>
        </details>
        <details class="faq-item">
          <summary>Кто имеет право на пособие для беременных?</summary>
          <p>Право на пособие имеют беременные женщины, вставшие на медицинский учет в медицинской организации в срок до 12 недель беременности. Основные условия: гражданство РФ и постоянное проживание в России, среднедушевой доход семьи ниже прожиточного минимума на душу населения в регионе.</p>
        </details>
        <details class="faq-item">
          <summary>Как рассчитывается размер пособия для беременных?</summary>
          <p>Размер пособия составляет 50%, 75% или 100% от регионального прожиточного минимума для трудоспособного населения. Базовый размер — 50%. Если даже с этой выплатой доход семьи не достигает прожиточного минимума, назначается 75%. Если и этого недостаточно — назначается 100%.</p>
        </details>
        <details class="faq-item">
          <summary>До какого срока выплачивается пособие?</summary>
          <p>Пособие для беременных выплачивается ежемесячно до родов. После рождения ребенка необходимо оформить единое пособие на ребенка, которое будет выплачиваться до достижения им возраста 17 лет.</p>
        </details>
        <details class="faq-item">
          <summary>Какие документы нужны для оформления?</summary>
          <p>Для оформления пособия потребуется: паспорт, справка из медицинского учреждения о постановке на учет по беременности, документы о доходах всех членов семьи за последние 12 месяцев, а также документы, подтверждающие состав семьи.</p>
        </details>
      </section>
...
const description = `Рассчитайте онлайн размер единого пособия для беременных женщин в ${regionGenitive}. Калькулятор учтет прожиточный минимум, установленный в вашем регионе, для точного и актуального расчета.`
...
useSeoMeta({
  ...
  keywords: `единое пособие, пособие беременным, пособие по беременности, калькулятор пособий, ${regionGenitive}, 2025, прожиточный минимум`
})
...
// Стили полностью скопированы из компонента для детей для консистентности
